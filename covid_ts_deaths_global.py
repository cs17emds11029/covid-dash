...
class Covid19:
    ...
    def __init__(self):
        self.covid_ts_global = pd.read_csv(covid_ts_global_url)
    ...
    def transform_and_write_global(self):
        ...
        covid_ts_global['Province/State'].fillna(covid_ts_global['Country/Region'],inplace=True)
            
        covid_ts_global['Province/State'] = covid_ts_global['Country/Region']
        
        self.covid_ts_global = covid_ts_global.pivot_table(columns=['Province/State','Country/Region']).reset_index()
