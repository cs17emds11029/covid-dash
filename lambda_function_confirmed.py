...
class Covid19:
    ...
    def transform_and_write_global(self,access_key,secret_access):
        ...
        self.covid_ts_global['Province/State'].fillna(self.covid_ts_global['Country/Region'],inplace=True)
        ...
        self.write_to_s3("covid_ts_global.csv",
                         self.covid_ts_global,
                         access_key,
                         secret_access)
...
def lambda_handler(event, context):
    Covid19obj = Covid19()
    Covid19obj.transform_and_write_global(event['ACCESS_KEY'],
                                          event['SECRET_ACCESS'])